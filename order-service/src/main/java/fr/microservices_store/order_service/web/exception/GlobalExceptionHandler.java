package fr.microservices_store.order_service.web.exception;

import fr.microservices_store.order_service.domain.InvalidOrderException;
import fr.microservices_store.order_service.domain.OrderNotFoundException;
import java.net.URI;
...
class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private static final URI BAD_REQUEST_TYPE = URI.create("https://api.store.com/errors/bad-request");
    ...
    // Override ResponseEntityExceptionHandler method to return a ProblemDetail body
    @Override
    @Nullable
